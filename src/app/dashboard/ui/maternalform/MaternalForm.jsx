...
export default function SimpleComponent() {
  return (
    <div style={{ padding: "1rem", background: "#f0f4fa", borderRadius: "8px" }}>
      <h2>Hello, this is a simple React component!</h2>
      <p>You can reuse this as a starting point for your own components.</p>
    </div>
  );
}
